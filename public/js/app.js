...
class BaseComponent {
  ...
  _queueCallback(callback, element, isAnimated = true) {
    ...
    const transitionDuration = (0,_util_index__WEBPACK_IMPORTED_MODULE_1__.getTransitionDurationFromElement)(element)
    _dom_event_handler__WEBPACK_IMPORTED_MODULE_2__.default.one(element, 'transitionend', () => (0,_util_index__WEBPACK_IMPORTED_MODULE_1__.execute)(callback))
